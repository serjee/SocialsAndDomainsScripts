...
/**
 * This is the model class for table "{{interdomains}}".
 *
 * The followings are the available columns in table '{{interdomains}}':
 * @property string $id
 ...
 * @property integer $interception
 * @property integer $success
 * @property string $date
 */
class Interdomains extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Interdomains the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('interception, success', 'numerical', 'integerOnly'=>true),
			...
			array('id, domain, cy, pr, dmoz, dmoz_count, wa, wa_count, glue_cy, glue_pr, yaca, interception, success, date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('interception',$this->interception);
