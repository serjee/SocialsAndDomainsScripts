...
return array(
	...
	'name'              =>  'uriPage - Ваше имя в интернете!',
	...
	'import'=>array(
        ...
        'application.widgets.*',
        // load Whois extension
        'ext.Whois.Whois',
        // load YiiMailer extension
        'ext.YiiMailer.YiiMailer',
        // helpers
        'application.helpers.UString',
	),
	...
	'modules'=>array(
        ...
        // enable "whois" module for working with Whois
        'whois'=>array(
		...
		'gii'=>array(
			...
			'ipFilters'=>array('127.0.0.1','79.120.123.159','77.51.66.48','::1'),
        ...
        'log'=>array(
			...
			'routes'=>array(
				array(
                    ...
                    'class'=>'CWebLogRoute',
                    'levels'=>'error, warning, trace, profile, info, log',
                    'enabled'=>false,
				),
			),
		),
